...
| M6 | Files, projects, system, stubs | `prd/M6.md` | 🔧 in progress (T1 storage, T2 file commands, T3 system variables, T4 PRG* source-edit, T5 misc/limitation stubs done; T6 multi-slot todo) |
